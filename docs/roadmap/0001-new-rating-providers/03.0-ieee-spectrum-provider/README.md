...
|----|---------|------|------------|--------|
| 01 | [Source note & legal/source-policy gate](/docs/roadmap/0001-new-rating-providers/03.0-ieee-spectrum-provider/01-source-note-and-policy-gate.md) | Security Auditor | - | ⬜ Not started |
| 02 | [IEEE language aliases](/docs/roadmap/0001-new-rating-providers/03.0-ieee-spectrum-provider/02-ieee-aliases.md) | Python Expert | 01.0/02 | ⬜ Not started |
